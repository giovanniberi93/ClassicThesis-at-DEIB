...
The example applications have been selected in order to challenge perception and action capabilities, and to achieve vineyard monitoring, navigation and manipulation tasks. 
...
\begin{figure}
	...
	\centering
	\subfloat[]{%
		\includegraphics[width=0.9\textwidth]{Images/grape_project/prunedVine.jpg}
		\label{fig:vignaSenzaFoglie}}
	\end{minipage}
	\begin{minipage}[c]{.5\textwidth}
	\subfloat[]{%
		\includegraphics[width=1\textwidth]{Images/grape_project/leavesVine.jpg}
...
\begin{figure}
	...
	\subfloat[]{%
		\includegraphics[width=0.6\textwidth]{Images/grape_project/dispenser1.png}
		\label{fig:dispenser1}}
	\end{minipage}
	\begin{minipage}[]{.5\textwidth}
	\subfloat[]{%
		\includegraphics[width=0.6\textwidth]{Images/grape_project/dispenserNostro.jpg}
