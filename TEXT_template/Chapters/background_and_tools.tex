...
\begin{figure}
	\centering
	\subfloat[]{%
		\includegraphics[width=0.3\textwidth]{Images/background_and_tools/localGlobalCostmap.png}
		\label{fig:localGlobalCostmap1}}
	\qquad
	\subfloat[]{%
		\includegraphics[width=0.31\textwidth]{Images/background_and_tools/localGlobalCostmap2.png}
