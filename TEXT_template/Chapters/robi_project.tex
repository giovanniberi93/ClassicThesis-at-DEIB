...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=2cm,align=center,
	...
	\node[state, fill=palette1, minimum width=60pt,text width=60pt]			(A)	{On-board PC};
	\node[state, fill=palette3, minimum width=60pt,text width=60pt]			(B)	[above right = of A] {Nucleo board};
	\node[state, fill=palette3, minimum width=60pt,text width=60pt]			(C)	[above left = of A] {LMS291};
	\node[state, fill=palette3, minimum width=60pt,text width=60pt]			(D)	[left = of A] {LD-MRS};
	\node[state, fill=palette3, minimum width=60pt,text width=60pt]			(E)	[right = of A] {GPS};
	\node[state, fill=palette4, minimum width=60pt,text width=60pt]			(F)	[below right = of A] {RocketM5};
	\node[state, fill=palette2, minimum width=60pt,text width=60pt]			(G)	[right = of B] {Motor \\control board};
	\node[state, fill=palette4, minimum width=60pt,text width=60pt]			(H)	[right = of F] {Nanostation};	
	\node[state, fill=palette5, minimum width=60pt,text width=60pt]			(I)	[below = of H] {Remote PC};	
	\node[state, fill=palette2, minimum width=60pt,text width=60pt]			(L)	[below left = of A] {Kinova\\Jaco$^2$};	
